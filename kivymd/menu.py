...
<MDMenuItem>
    ...
    height: dp(48)
    padding: dp(16), 0
    on_release: root.parent.parent.parent.parent.set_selected(root.text)
...
class MDDropdownMenu(ThemableBehavior, BoxLayout):
    ...
    def set_selected(self, selected_item):
        ...
        self.obj_from.text = self.selected_item

    def return_selected(self,id):
        self.obj_from = id
        self.obj_from.text = ' '
