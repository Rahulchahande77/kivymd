...
FONTS = [
    {
        "name": "Roboto",
        "fn_regular": fonts_path + 'gargi.ttf',
        "fn_bold": fonts_path + 'nirmalab.ttf',
        "fn_italic": fonts_path + 'nirmala.ttf',
        "fn_bolditalic": fonts_path + 'nirmala.ttf'
    },
    {
        "name": "RobotoLight",
        "fn_regular": fonts_path + 'gargi.ttf',
        "fn_bold": fonts_path + 'nirmalab.ttf',
        "fn_italic": fonts_path + 'NirmalaS.ttf',
        "fn_bolditalic": fonts_path + 'NirmalaS.ttf'
    },
    {
        "name": "Icons",
