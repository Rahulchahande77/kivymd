...
from kivymd.bottomsheet import MDGridBottomSheet, MDListBottomSheet
from kivymd.button import MDIconButton, MDFlatButton, MDRaisedButton
from kivymd.date_picker import MDDatePicker
from kivymd.dialog import MDDialog
from kivymd.label import MDLabel
from kivymd.list import BaseListItem, ILeftBody, ILeftBodyTouch, IRightBodyTouch
...
#:import MDSelect kivymd.textfields.MDSelect
#:import MDSpinner kivymd.spinner.MDSpinner
#:import MDCard kivymd.card.MDCard
#:import MDDataTable kivymd.data_table.MDDataTable
...
NavigationLayout:
    ...
    MDNavigationDrawer:
        ...
        NavigationDrawerIconButton:
            icon: 'checkbox-blank-circle'
            text: "Data Table"
            on_release: app.root.ids.scr_mngr.current = 'data_table'
        NavigationDrawerIconButton:
            icon: 'checkbox-blank-circle'
            text: "Other Data Table"
            on_release: app.root.ids.scr_mngr.current = 'other_table'    
        NavigationDrawerIconButton:
            icon: 'checkbox-blank-circle'
            text: "Dialogs"
    ...
    BoxLayout:
        ...
        ScreenManager:
            ...
            Screen:
                name:'data_table'
                on_pre_enter:app.table = dt
                on_enter:app.populate_data()
                MDCard:
                    padding:10
                    MDDataTable:
                        id:dt
                        data:app.table_data if app.table_data else []
                        _min_list_height:dp(100)
                        _list_vertical_padding:dp(10)
                        action:['edit','delete']               
            Screen:
                name:'other_table'
                MDCard:
            ...
            Screen:
                ...
                MDRaisedButton:
                    text: "Open filebrowser "
                    size_hint: None, None
                    size: 3 * dp(48), dp(48)
                    pos_hint: {'center_x': 0.5, 'center_y': 0.3}
                    opposite_colors: True
                    on_release: app.choose_file('*.jpg','*.png')    
            Screen:
                name: 'grid'
                ScrollView:
                    do_scroll_x: False
                ...
                ScrollView:
                    BoxLayout:
                        ...
                        MDRaisedButton:
                            ...
                            size_hint: None, None
                            tooltip_text:"Tooltips for any buttons "
                            size: 4 * dp(48), dp(48)
            ...
            Screen:
                ...
                ScrollView:
                    BoxLayout:
                        ...
                        MDSelect:
                            hint_text: "MDSelect+header & footer"
                            options:['Option 1','Option 2','Option 3','Option 4']
                            header:'HEADER'
                            footer:'FOOTER'
                            on_touch_down:self.bind(isheaderclicked=app.headerclick)
                            on_touch_down:self.bind(isfooterclicked=app.footerclick)    
                        MDTextField:
...
class KitchenSink(App):
    ...
    table_data = [
        OrderedDict([('Dessert', 'Dessert'), ('Calories', 'Calories'), ('Fat', 'Fat'),
                     ('Carbs', 'Carbs'), ('Protein', 'Protein'), ('Sodium', 'Sodium'),
                     ('Calcium', 'Calcium'), ('Iron', 'Iron')]),
        OrderedDict([('Dessert', u'Frozen yogurt'), ('Calories', u'159'), ('Fat', u'6.0'),
                     ('Carbs', 24), ('Protein', 4.0), ('Sodium', 87), ('Calcium', 14),
                     ('Iron', u'1%')]),
        OrderedDict(
            [('Dessert', u'Ice cream'), ('Calories', u'237'),
             ('Fat', u'9.0'),
             ('Carbs', 37), ('Protein', 4.3), ('Sodium', 129), ('Calcium', 8),
             ('Iron', u'1%')]),
        OrderedDict([('Dessert', u'Cupcake'), ('Calories', u'305'),
                     ('Fat', u'3.7'), ('Carbs', 67), ('Protein', 4.3), ('Sodium', 413),
                     ('Calcium', 3), ('Iron', u'8%')]), OrderedDict(
            [('Dessert', u'Jelly bean'), ('Calories', u'375'), ('Fat', u'0.0'),
             ('Carbs', 94), ('Protein', 0.0), ('Sodium', 50), ('Calcium', 0),
             ('Iron', u'0%')]),
        OrderedDict([('Dessert', u'Lollipop'), ('Calories', u'392'), ('Fat', u'0.2'),
                     ('Carbs', 98), ('Protein', 0), ('Sodium', 38), ('Calcium', 0),
                     ('Iron', u'2%')]), OrderedDict(
            [('Dessert', u'Honeycomb'), ('Calories', u'408'), ('Fat', u'3.2'),
             ('Carbs', 87), ('Protein', 6.5), ('Sodium', 562), ('Calcium', 0),
             ('Iron', u'45%')]), OrderedDict(
            [('Dessert', u'Donut'), ('Calories', u'452'), ('Fat', u'25.0'),
             ('Carbs', 51), ('Protein', 4.9), ('Sodium', 326), ('Calcium', 2),
             ('Iron', u'22%')]),
        OrderedDict(
            [('Dessert', u'KitKat'), ('Calories', u'518'), ('Fat', u'26.0'),
             ('Carbs', 65), ('Protein', 7), ('Sodium', 54), ('Calcium', 12),
             ('Iron', u'6%')]),

        OrderedDict(
            [('Dessert', u'KitKat 1'), ('Calories', u'518'), ('Fat', u'26.0'),
             ('Carbs', 65), ('Protein', 7), ('Sodium', 54), ('Calcium', 12),
             ('Iron', u'6%')]),
        OrderedDict(
            [('Dessert', u'KitKat 2'), ('Calories', u'518'), ('Fat', u'26.0'),
             ('Carbs', 65), ('Protein', 7), ('Sodium', 54), ('Calcium', 12),
             ('Iron', u'6%')]),
        OrderedDict(
            [('Dessert', u'KitKat 3'), ('Calories', u'518'), ('Fat', u'26.0'),
             ('Carbs', 65), ('Protein', 7), ('Sodium', 54), ('Calcium', 12),
             ('Iron', u'6%')]),
        OrderedDict(
            [('Dessert', u'KitKat 4'), ('Calories', u'518'), ('Fat', u'26.0'),
             ('Carbs', 65), ('Protein', 7), ('Sodium', 54), ('Calcium', 12),
             ('Iron', u'6%')]),
        OrderedDict(
            [('Dessert', u'KitKat 5'), ('Calories', u'518'), ('Fat', u'26.0'),
             ('Carbs', 65), ('Protein', 7), ('Sodium', 54), ('Calcium', 12),
             ('Iron', u'6%')]),

        OrderedDict(
            [('Dessert', u'Gingerbread'), ('Calories', u'356'), ('Fat', u'16.0'),
             ('Carbs', 49), ('Protein', 3.9), ('Sodium', 327), ('Calcium', 7),
             ('Iron', u'16%')])]


    def choose_file(self,*args):
        from kivymd.filebrowserdialog import MDFileBrowser
        self.content = MDFileBrowser(size_hint=(None,None),width=700, height=600, filters=args)

        def select_path(instance):
            Snackbar(text="Selected file "+instance.selection[0]).show()
            self.content.dismiss()

        def dismiss(instance):
            self.content.dismiss()

        self.content.bind(on_success=select_path,
                     on_canceled=dismiss)
        self.content.open()



    def headerclick(self,*args):
        Snackbar(text="Header is clicked").show()

    def footerclick(self,*args):
        Snackbar(text="Footer is clicked").show()



    def populate_data(self, *args):
        self.start = 0
        self.end = len(self.table_data) + 1

        if self.table.data != []:
            # self.table.bind(isedit=self.edit_row)
            # self.table.bind(isdelete=self.delete_row)
            self.table.set_sort_callback(self.sort)
            self.table.set_display_range(0, self.end)
            self.table.populate()
            self.table.selected_id = ''
...
class DataTableScreen(Screen):
    pagination_container = ObjectProperty()
    pagination_info_label = ObjectProperty()
    ...
    ITEMS_PER_PAGE = 5
    number_of_pages = 0
    pagination_info = StringProperty()
    ...
    def on_enter(self):
        self.data_table.data = self.data
        self.refresh_pagination_info()
        self.data_table.set_sort_callback(self.sort)
        self.data_table.set_display_range(self.start, self.end)
        self.data_table.populate()

    def refresh_pagination_info(self):

        if self.has_pagination:
            self.start = self.selected_index
            self.end = self.start + self.ITEMS_PER_PAGE

        self.number_of_pages = len(self.data) / self.ITEMS_PER_PAGE
        self.number_of_pages += 1 if len(self.data) % self.ITEMS_PER_PAGE > 0 else 0

        self.pagination.clear_widgets()

        for i in range(int(self.number_of_pages), 0, -1):
            if self.selected_position + 1 == i:
                button = MDRaisedButton(text="{}".format(i),
                                        id="page{}".format(i),
                                        size_hint=(None, None),
                                        height=dp(24))
            else:
                button = MDFlatButton(text="{}".format(i),
                                      id="page{}".format(i),
                                      size_hint=(None, None),
                                      height=dp(24),
                                      on_release=self.select_page)
            self.pagination.add_widget(button)

        # Update the current items text
        start = self.selected_index + 1
        end = self.selected_index + self.ITEMS_PER_PAGE
        end = len(self.data) - 1 if end > len(self.data) - 1 else end
        self.pagination_info = "Showing {} to {} of {} entries".format(start, end,
                                                                       len(self.data) - 1)

    def select_page(self, button):
        self.selected_position = (int(button.text) - 1) if int(button.text) > 0 else 0
        self.selected_index = self.selected_position * self.ITEMS_PER_PAGE
        self.refresh_pagination_info()
        self.load_data(self.data)
        self.sort_for_pagination()

    def load_data(self, data):
        self.data_table.data = data
        if self.is_search_mode:
            self.data_table.set_display_range(0, len(data))
        else:
            self.data_table.set_display_range(self.start, self.end)
        self.data_table.populate(self.data_table.sorted_column_name, self.data_table.is_descending_sort)

    def sort_for_pagination(self):
        if self.data_table.sorted_column_name != "":
            self.sort(self.data_table.sorted_column_name, self.data_table.is_descending_sort)

    def sort(self, item, is_descending=False):
        # Separate headers from content cells
        header_row = self.data[0]
        content_rows = [self.data[i] for i in range(1, len(self.data))] if not self.is_search_mode \
            else [self.data_table.data[i] for i in range(1, len(self.data_table.data))]

        if len(self.data) > 0:
            # Sort only content items and then append it to headers
            sorted_data = sorted(content_rows,
                                 key=lambda x: datetime.datetime.strptime(x[item.text], '%d-%m-%Y'),
                                 reverse=not is_descending) if self.is_date(content_rows[0][item]) \
                else sorted(content_rows, key=itemgetter(item), reverse=not is_descending)
            sorted_data.insert(0, header_row)
            self.is_sorted = True
            # Set as data source for table and repopulate
    ...
    def filter_list(self, query):
        ...
        if self.search_text != "" and self.has_pagination:
            self.pagination_container.remove_widget(self.pagination_info_label)
            self.pagination_container.remove_widget(self.pagination)
            self.has_pagination = False
        elif self.search_text == "" and not self.has_pagination:
            self.pagination_container.add_widget(self.pagination_info_label)
            self.pagination_container.add_widget(self.pagination)
        ...
        if query == "":
            ...
            self.load_data(self.filter_items(query))

    def filter_items(self, query_text):
        content_rows = [self.data[i] for i in range(1, len(self.data))]
        header_row = self.data[0]
        filtered_list = [header_row]
        for row in content_rows:
            for cell in row.values():
                if str(cell).lower().__contains__(query_text) and not filtered_list.__contains__(
                        row):
                    filtered_list.append(row)
        return filtered_list

    def new_item(self):
        hashed_id = self.data_table.selected_id
        if hashed_id == -1:
            Snackbar(text="No Item Selected!").show()
        else:
            # Get the currently selected row using the helper method from DataTable
            selected_row = self.data_table.find_row_by_id(hashed_id)
            # Get the required value using it's key from the selected row
            title = selected_row['Dessert']
            # Display SnackBar!
            Snackbar(text="New Called on item # {}!".format(title)).show()

    def edit_item(self):
        index = self.data_table.selected_id
        if index == -1:
            Snackbar(text="No Item Selected!").show()
        else:
            Snackbar(text="Edit Called on item # {}!".format(index)).show()
    ...
    def delete_item(self):
        ...
        if index == -1:
            ...
            Snackbar(text="Delete Called on item # {}!".format(index)).show()
