...
from kivymd.filebrowser import FileChooserThumbView
...
#:import FileChooserThumbView kivymd.filebrowser.FileChooserThumbView
...
<TreeLabel>:
    color:(0,0,0,1)
    color_selected:app.theme_cls.primary_light
    on_touch_down:
    ...
    # on_touch_down:self.color=(1,1,1,1)  if self.parent.browser.path != self.path and not self.is_open else(0,0,0,1) 
...
<MDFileBrowser>:
        ...
        BoxLayout:
            ...
            BoxLayout:
                ...
                TextInput:
                    ...
                    valign: 'middle'
                    on_text_validate:root.path=self.text
                ...
                Button:
                    ...
                    size_hint:None,None
                    size:dp(48),dp(48)
                    background_normal:'atlas://kivymd/images/filebrowser_atlas/filechooser_folder'
                    background_down:'atlas://kivymd/images/filebrowser_atlas/filechooser_folder'
                    on_press:root.path=path_field.text
                ...
                MDIconButton:
                    ...
                    on_press:root.path=root.back_path()
    ...
    BoxLayout:
        ...
        TextInput:
            ...
            write_tab: False
            background_active:self.background_normal
            on_text:root.filters = self.text.split(',') if self.text else []
            multiline: False
            size_hint_y:None
            height:self.minimum_height
    ...
    BoxLayout:
        ...
        MDRaisedButton:
            id: select_button
            disabled:True if file_text.text==''  else False
...
class LinkTree(TreeView):
    ...
    root_options = {'text': 'Quick access', 'font_size': 20, 'color': (0, 0, 0, 1)}
...
class MDFileBrowser(MDCard,ModalView):
    ...
    def __init__(self, **kwargs):
        super(MDFileBrowser, self).__init__(**kwargs)
    ...
    class TestApp(App):
        ...
        def build(self):
            if platform == 'win':
                ...
                user_path = expanduser('~') + sep + 'Documents'
            browser = MDFileBrowser(select_string='Select',
                                    favorites=[(user_path, 'Documents')])
